...
# col5 = Collection.create(:title => "Heels", :description => "freaking high", :user_id=>2)
# col6 = Collection.create(:title => "sunglasses", :description => "shades for the sunny days", :user_id=>2)
# col7 = Collection.create(:title => "Flowers", :description => "all my pictures for flowers!", :user_id=>2)
# # Generating four photos per collection
# #pens
# photo1 = Photo.create(:title=> "Simling flower", :user_id=>1, :collection_id=>1, :caption=>"pen from van", :image=>"http://fsymbols.com/images/mario-flower.png")
